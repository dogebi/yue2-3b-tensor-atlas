...
/* This atlas measures bytes; the rows above are the comparison set published by the original atlas
   page (each model's own card), reproduced so the selector keeps the same options. YuE2-3B is a
   music model and has no row in that set — nothing here is a score for this checkpoint. */
